...
header = ['Page number', 'City', 'Neighborhood','Size', 'Number of rooms', 'Floor number','Taxes' ,'Price'] + feature_names

with open('raw_apartment_data.csv', 'a', encoding='UTF8', newline='') as f:
    writer = csv.writer(f)
