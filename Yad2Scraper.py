...
header = ['Post link', 'City', 'Neighborhood','Size', 'Number of rooms', 'Floor number','Taxes' ,'Price', 'Room mates', 'Furniture', 'Elevator', 'Air conditioner', 'Parking', 'Balcony', 'Bars', 'Shelter', 'Storeroom', 'Renovated', 'Boiler', 'Pets allowed']

with open('raw_yad2_data-test.csv', 'a', encoding='UTF8', newline='') as f:
    writer = csv.writer(f)
    ...
    for page_num in range(first_page,last_page):
        ...
        posts_colapsed = driver.find_elements(By.CLASS_NAME, "date")
        print('amount', len(posts_colapsed))
        ...
        for post in posts:
            ...
            try:
                ...
                size, taxes, parking, balcony = None, None, None
                ...
                rooms = ''.join([n for n in rooms_dom.text if n.isdigit()])
                ...
                # Get tab link for the post. This is to differ diffeerent posts
                a_link = None
                try:
                ...
                data_row = [a_link, city, neighborhood, size, rooms, floor, taxes, price, features_dict['Room mates'], features_dict['Furniture'], features_dict['Elevator'], features_dict['Air conditioner'], parking, balcony, features_dict['Bars'], features_dict['Shelter'], features_dict['Storeroom'], features_dict['Renovated'], features_dict['Boiler'], features_dict['Pets allowed']]
